...
//        config.setOriginParser(request -> request.getHeader("S-user"));
    ...
    @Bean
    public FilterRegistrationBean<LoggerTraceFilter> loggerFilter() {
        FilterRegistrationBean<LoggerTraceFilter> registration = new FilterRegistrationBean<LoggerTraceFilter>();
        LoggerTraceFilter filter = new LoggerTraceFilter();
